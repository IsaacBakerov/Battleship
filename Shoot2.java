...
public class Shoot2 {
    public static int aircraftCarrierLength1 = 5;
    public static int battleshipLength1 = 4;
    public static int submarineLength1 = 3;
    public static int cruiserLength1 = 3;
    public static int destroyerLength1 = 2;
    public static int allLength1 = 17;
    ...
    public static void shoot2() {
        ...
        if (hit == 1 || hit == 3) {
            ...
            } else if (aircraftCarrierLength1 == 0) {
                System.out.print("\nYou sank a ship!");
                aircraftCarrierLength1--;
            } else if (battleshipLength1 == 0) {
                System.out.print("\nYou sank a ship!");
                battleshipLength1--;
            } else if (submarineLength1 == 0) {
                System.out.print("\nYou sank a ship!");
                submarineLength1--;
            } else if (cruiserLength1 == 0) {
                System.out.print("\nYou sank a ship!");
                cruiserLength1--;
            } else if (destroyerLength1 == 0) {
                System.out.print("\nYou sank a ship!");
                destroyerLength1--;
            } else {
                System.out.print("\nYou hit a ship!");
    ...
    public static int hit(int aIndex, int n) {
        int hit = 0;
        if (field1[aIndex][n] == "O") {
            field1[aIndex][n] = "X";
            foggyField1[aIndex][n] = "X";
            hit = 2;
        } else if (field1[aIndex][n] == "~") {
            field1[aIndex][n] = "M";
            foggyField1[aIndex][n] = "M";
            hit = 1;
        } else if (field1[aIndex][n] == "X") {
            hit = 4;
        } else if (field1[aIndex][n] == "M") {
            hit = 3;
        }
